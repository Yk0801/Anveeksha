    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-14">
          <p className="text-[#F97316] font-semibold text-sm uppercase tracking-widest mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>About Us</p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
            className="bg-gradient-to-br from-[#F97316]/5 to-[#4F46E5]/5 rounded-2xl p-8 border-l-4 border-[#F97316]">
            <p className="text-2xl sm:text-3xl font-bold text-slate-800 leading-snug italic"
              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              "We believe the best education starts with a single question: <span className="text-[#F97316]">Why?</span>"
            </p>
            <p className="mt-4 text-[#F97316] font-semibold text-sm" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s, i) => (
            <motion.div key={s.label} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i + 3}
              ...
              <p className="text-4xl font-bold text-[#F97316] mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>

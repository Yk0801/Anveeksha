          ...
          <div className="hidden md:flex items-center gap-5">
            {navLinks.map((l) => (
              <button
                ...
                className={`text-sm font-medium transition-colors hover:text-[#F97316] ${scrolled ? "text-slate-700" : "text-white/90 hover:text-white"}`}
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-4 border-b">
                <span className="font-bold text-[#F97316]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Sri Anveeksha</span>
              ...
              <div className="p-4 border-t space-y-2">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 text-sm text-[#F97316] font-semibold py-2.5 rounded-lg border border-[#F97316]/30 hover:bg-orange-50 transition-colors"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                  <GraduationCap className="w-4 h-4" />
                  Parent Login
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 text-sm text-[#4F46E5] font-semibold py-2.5 rounded-lg border border-[#4F46E5]/30 hover:bg-indigo-50 transition-colors"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                  <ShieldCheck className="w-4 h-4" />
                  Admin Login
